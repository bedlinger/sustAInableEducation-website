<template>
    <div class="flex flex-col">
        ...
        <section class="section-odd flex flex-col justify-center items-center gap-12">
...
onNuxtReady(() => {
    sustainableWordChangeInterval.value = setInterval(() => {
        if(wordPointer.value >= sustainableWords.length-1)
            wordPointer.value = 0
        else
            wordPointer.value++
    }, 4000)
...
const milestones = [
    ...
    {
        date: '15.10.2024',
        milestone: 'Mockup der Website fertiggestellt, Datenbank aufgesetzt, Benutzernamen Erstellung fertiggestellt',
        completed: false
    },
    {
        date: '08.11.2024',
        milestone: 'Prototyp der Website fertiggestellt, Prototyp der Story Generierung fertiggestellt',
        completed: false
    },
    {
        date: '10.12.2024',
        milestone: 'Usability Tests durchgeführt, Prototyp der Quiz Generierung fertiggestellt',
        completed: false
    },
    {
        date: '24.01.2025',
        milestone: 'Beta-Version der Website, Backend und Prompts zur Generierung fertiggestellt',
        completed: false
    },
    {
        date: '11.02.2025',
